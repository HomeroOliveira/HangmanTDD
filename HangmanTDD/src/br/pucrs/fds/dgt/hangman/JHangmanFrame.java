...
public class JHangmanFrame extends JFrame {
    ...
    private ReaderWords readerWords;
	...
	// readerWords = new
	// ReaderWords(Paths.get("/br/pucrs/fds/dgt/hangman/words.txt"));
	// game = new Hangman(readerWords.getWord());
	...
	return new ImageIcon(
		JHangmanFrame.class.getResource("/br/pucrs/fds/dgt/hangman/Images/Hangman-" + num + ".png"));
    }
